...
(function (root, factory) {
  ...
  const DEFAULTS = {
    ...
    batchSize: 10,        // reports asked for back to back, then collected
    askGapSeconds: 15,    // pause between one request to Amazon and the next
    gapSeconds: 5,        // pause between collecting one report and the next
