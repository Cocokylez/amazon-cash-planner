...
(function (root, factory) {
  ...
  function create() {
    ...
    return {
      ...
      /* A report asked for earlier (status "requested"): fetch it now. */
      collect: id => call('/jobs/' + encodeURIComponent(id) + '/collect', { method: 'POST' }),
  ...
  const WORDS = {
    ...
    requested: 'Asked Amazon; collected once it is built',
